...
.PHONY: all c asm gpio stack timers pwm usart bridge robust spi twi eeprom adc data disasm size check clean

all: c asm gpio stack timers pwm usart bridge robust spi twi eeprom adc data
