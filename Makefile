...
.PHONY: all c asm gpio stack timers pwm usart bridge robust spi twi eeprom adc disasm size check clean

all: c asm gpio stack timers pwm usart bridge robust spi twi eeprom adc
