...
-   :material-school:{ .lg .middle } **Start in English**
    ...
    [:octicons-arrow-right-24: Start the English course](en/COURSE_OUTLINE.md)

-   :material-school-outline:{ .lg .middle } **Start på norsk**

    ---

    Følg kurset fra oppsett av verktøykjeden via AVR-arkitektur, GPIO, avbrudd og seriell kommunikasjon til videregående emner.

    [:octicons-arrow-right-24: Start det norske kurset](no/COURSE_OUTLINE.md)

-   :material-memory:{ .lg .middle } **Close to the hardware**

    ---

    Learn registers, memory, peripherals and the CPU directly instead of hiding them behind a framework.

-   :material-tools:{ .lg .middle } **Open toolchain**
...
=== "English"
    ...
    Begin with the [English course outline](en/COURSE_OUTLINE.md), then work through the lessons in order. Use the appendices when you want to dig deeper into a topic.
...
[:octicons-mark-github-16: View EduAVR on GitHub](https://github.com/Ploos-AS/EduAVR){ .md-button }
